...
export default function HttpNode({ id, data }) {
  ...
  return (
    ...
    >
      ...
      {/* Accent border */}
      <div className="w-[3px] bg-[#2563eb] rounded-l-lg" />
      ...
      <Handle type="target" position={Position.Left} className="w-2 h-2 !bg-[#2563eb] !border-transparent" />
      <Handle type="source" position={Position.Right} className="w-2 h-2 !bg-[#2563eb] !border-transparent" />
    </div>
  );
}
